<template>
  <div>
    ...
    <el-button type="primary" @click="addParentGoodsList">添加分类</el-button>
    ...
    >
      ...
      <!-- 操作 -->
      <template v-slot:opt="scope" class="last_caoz">
        <el-button
          type="primary"
          icon="el-icon-edit"
          size="mini"
    ...
    >
      ...
      >
        ...
        <el-form-item label="父级分类:" prop="cat_Par">
          <div class="block select_from" width="100%">
            <el-cascader
              v-model="changeCateInfo"
